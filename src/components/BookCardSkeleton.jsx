...
const BookCardSkeleton = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 md:gap-6 mt-10">
      ...
      {[1, 2, 3, 4, 5, 6, 8, 9].map((_, index) => (
        ...
        >
          ...
          >
            <div class="flex items-center justify-center h-48 bg-gray-200 rounded-sm w-[330px] " />
          </div>
