...
const BookDetails = () => {
  ...
  console.log("book", book); // Debugging line to check the book object

  return (
    <div className="container mx-auto mt-24 mb-14 p-8 bg-white shadow-md rounded-lg border border-gray-200">
      ...
      <img
        ...
        alt={book.title}
        className="w-[20%] object-cover rounded-lg mb-4 mt-2"
      />
